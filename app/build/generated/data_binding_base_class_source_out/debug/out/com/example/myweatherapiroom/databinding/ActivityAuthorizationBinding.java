...
public final class ActivityAuthorizationBinding implements ViewBinding {
  ...
  private ActivityAuthorizationBinding(@NonNull LinearLayout rootView,
      @NonNull Button buttonSignIn2, @NonNull CheckBox checkbox,
  ...
  public static ActivityAuthorizationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAuthorizationBinding((LinearLayout) rootView, buttonSignIn2, checkbox,
          editTextTextPassword, editTextTextPersonName, textViewTitle);
    }
